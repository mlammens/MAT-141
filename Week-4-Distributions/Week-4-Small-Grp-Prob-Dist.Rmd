...
To answer this question, we need to calculate two different joint probability: P(poor health AND health coverage) and P(poor health AND no health coverage). We actually already calculated the second value above.

```{r}
prob_poorhealth_nocoverage

prob_poorhealth_yescoverage = poorhealth_yescoverage / total_participants
