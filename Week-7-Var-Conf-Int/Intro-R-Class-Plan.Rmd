---
title: "Introduction to R/RStudio - Class Plan"
output:
...
**Call this new folder `MAT-141`. I STRONGLY RECOMMEND THAT YOU DO NOT PUT THIS FOLDER ON YOUR DESKTOP.**
...
Go back to RStudio.
Let's make a new R Project associated with your `MAT-141` directory. 
...
Use the graphical user interface (GUI) to navigate to the `MAT-141` directory, then select "Create Project".
...
## Appendix - Accessing RStudio via Pace Virtual Lab

You can also access RStudio via the Pace Virtual Lab. 
While working with RStudio on your personal machine is the preferable approach for this class, it is possible to use the virtual lab if needed.
